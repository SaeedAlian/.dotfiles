...
bind 'set completion-display-width 100'
...
bind '"\C-h":"bash_hsearch 3000\n"'
bind '"\C-o":"fastfetch\n"'
bind '"\C-n\C-n":"dnote -f\n"'
bind '"\C-n\C-a":"dnote -af\n"'
bind '"\C-p":"dnote -p\n"'
...
PS1="\[\033[1;34m\] \$(parse_logo) \[\e[1;37m\] \W \[\e[1;32m\]\$(parse_git_branch)\[\033[31m\]\$(parse_git_dirty) \[\e[1;34m\] \[\e[1;37m\]"
